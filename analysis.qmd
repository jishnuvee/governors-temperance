...
I predict taht candidates who win an election lvie a few years longer than they would have otherwise, but I would not be suprised if, in fact, the effect is actually negative. My best guess is 3 years +/- 8 b/cuz we do a lot of assumptions. Our initial sentences/conclusion we attempt to not even give a precise number. 